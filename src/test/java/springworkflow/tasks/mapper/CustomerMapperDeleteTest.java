...
public class CustomerMapperDeleteTest {
	...
	class Correct {
		...
		static final String SETUP_TEST_DATA_PATH = "TestData/CustomerMapper/delete/setup/";
		static final String SUCCESS_TEST_DATA_PATH = "TestData/CustomerMapper/delete/expected/";
		...
		public void testSuccess() throws Exception {
			Customer customer = new Customer("KA0015", "", "", "", "", 0);
			Boolean actual = sut.delete(customer);
		...
		@Test
		@DisplayName("削除が失敗する場合（得意先が未登録）")
		public void testNotFound() throws Exception {
			Customer customer = new Customer("KA9999", "", "", "", "", 0);
			Boolean actual = sut.delete(customer);
		...
		@Test
		@DisplayName("削除が失敗する場合（得意先が削除済み）")
		public void testDeleted() throws Exception {
			Customer customer = new Customer("KA0002", "", "", "", "", 0);
			Boolean actual = sut.delete(customer);
			assertThat(actual).isTrue();
