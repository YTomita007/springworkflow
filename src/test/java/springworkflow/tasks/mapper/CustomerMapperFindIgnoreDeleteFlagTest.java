...
public class CustomerMapperFindIgnoreDeleteFlagTest {
	...
	class Correct {
		...
		static final String TEST_DATA_PATH = "TestData/CustomerMapper/findIgnoreDeleteFlag/";
		...
		@Test
		@DisplayName("検索が成功する場合（未削除）")
		public void testCustomer() throws Exception {
			Customer customer = new Customer("KA0001", "Aストア", "045-128-3581", "220-0001", "横浜市西区北幸２－１", 0);
			Customer actual = sut.findIgnoreDeleteFlag("KA0001");
			assertThat(actual).isEqualTo(customer);
		}

		@Test
		@DisplayName("検索が成功する場合（削除済）")
		public void testDeletedCustomer() throws Exception {
			Customer customer = new Customer("KA0002", "Bストア", "045-128-3582", "220-0002", "横浜市西区浅間２－２", 0);
			Customer actual = sut.findIgnoreDeleteFlag("KA0002");
			assertThat(actual).isEqualTo(customer);
		}
		...
		public void testIncorrectCode() throws Exception {
			Customer actual = sut.findIgnoreDeleteFlag("KA9999");
	...
	class DatabaseWrong {
		...
		public void testNotFoundCustomerTable() throws Exception {
			assertThrows(DataAccessException.class, () -> {
				sut.findIgnoreDeleteFlag("KA0001");
			});
		}
